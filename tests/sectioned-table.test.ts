...
type SectionRow = ReturnType<typeof createDepartmentMarker> | ReturnType<typeof createTotalRow> | ReturnType<typeof createNumberInWordsRow>;
...
function createOvertimeTable(options: {
  subTitle: string;
  data: Array<TableRow>;
}) {
  return {
